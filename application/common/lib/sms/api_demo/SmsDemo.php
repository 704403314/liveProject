<?php
namespace app\common\lib\sms\api_demo;
...
class SmsDemo
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "AumoqZPeMmYE2Zi9"; // AccessKeyId  小心

        $accessKeySecret = "eY3livnHfR2fnjkeoG3TRIEbsKS1SJ"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phone=null,$content='test',$sign='短信认证',$code='SMS_15000102') {
